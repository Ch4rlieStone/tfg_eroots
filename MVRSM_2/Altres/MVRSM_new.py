...
class SurrogateModel:
    ...
    def minimum(self, x0):
        ...
        """
        res = minimize(self.g, x0, method='L-BFGS-B',
                       bounds=self.bounds, jac=self.g_jac,
...
def MVRSM_minimize(obj_func, x0, lb, ub, num_int, max_evals, rand_evals=0, obj_threshold=0.0, args=(),
                   stop_crit=None, log_times=False, scale_threshold=1e-8):
    """

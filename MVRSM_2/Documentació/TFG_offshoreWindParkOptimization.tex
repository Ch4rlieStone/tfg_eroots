...
\begin{figure}[H] %Recorda fixar la posició de les figures si no
	\centering
	\includegraphics[width=0.35\textwidth]{imatges/ETSEIB.png}
...
\subsection{Reach of the thesis}
...
\subsection{Budget}
\subsection{Environmental study}
\subsection{Social, equity and gender studies}

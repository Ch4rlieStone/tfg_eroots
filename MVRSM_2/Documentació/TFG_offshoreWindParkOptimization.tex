...
\nomenclature[A]{HVAC}{High Voltage Alternating Curent}
...
\nomenclature[S]{$\underline{I}$}{Complex current}
\nomenclature[S]{$\underline{V}$}{Complex voltage}
\nomenclature[S]{$\underline{Z}$}{Complex impedance}
\nomenclature[S]{$\underline{Y}$}{Complex admittance}

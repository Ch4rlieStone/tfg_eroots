...
The goal of the project is todetermine where this compensation has to be placed  and how to size it. But this is only part of the design carachteristics we want to optimize. A full descrption of the optimitization variables will be
...
\begin{figure}[h]
    ...
    \begin{tikzpicture}[scale=1]
        ...
        \draw (3,0.4) -- (2,0.4);
        \draw (2,0.4) to [generic, l_=$\underline{Y}_{sh}$] (2,-2)node[ground]{};
        \draw (5,0.75) -- (6,0.75);
        ...
        \draw (5.75,0.4) -- (5,0.4);
        \draw (5,0.4) to [generic, l_=$\underline{Y}_{sh}$] (5,-2)node[ground]{};
        ...
        \draw (9,0.75) to [generic, l^=$\underline{Y}_{sh}$] (9,-2) node[ground]{};
        ...
        \draw (11.5,0.4) to [generic, l=$\underline{Y}_{sh}$] (11.5,-2)node[ground]{};
        ...
        \draw (15,0.4) -- (14,0.4);
        \draw (14,0.4) to [generic, l=$\underline{Y}_{sh}$] (14,-2) node[ground]{};
